...
ASM_FUNCTION_OBJ_FILES=sse2_functions.o avx_functions.o fma_functions.o fma4_functions.o avx512_functions.o 
ASM_FUNCTION_SRC_FILES_WIN=sse2_functions.c avx_functions.c fma_functions.c fma4_functions.c avx512_functions.c 
ASM_FUNCTION_OBJ_FILES_WIN=sse2_functions_win64.o avx_functions_win64.o fma_functions_win64.o fma4_functions_win64.o avx512_functions_win64.o 
...
FIRESTARTER: msr.o generic.o x86.o main.o init_functions.o work.o x86.o watchdog.o help.o ${ASM_FUNCTION_OBJ_FILES}
	${LINUX_CC} -o FIRESTARTER  msr.o generic.o  main.o  init_functions.o work.o x86.o watchdog.o help.o ${ASM_FUNCTION_OBJ_FILES} ${LINUX_L_FLAGS} -lm ${MSR_L_FLAGS} ${MSR_I_FLAGS}
...
msr.o: msr.c msr.h
	${LINUX_CC} -c $< ${OPT_STD} ${LINUX_C_FLAGS} ${MSR_I_FLAGS}
...
main.o: main.c work.h cpu.h
	${LINUX_CC} ${OPT_STD} ${LINUX_C_FLAGS} ${MSR_I_FLAGS} -c main.c
...
work.o: work.c work.h cpu.h
	${LINUX_CC} ${OPT_STD} ${LINUX_C_FLAGS} ${MSR_I_FLAGS} -c work.c
